...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhoast/coffeeshop/views/dashboard/';
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['id_usuario'])) {
            ...
            $this->setTitle('7mangas - Historial de ingresos', true);
    ...
    */
    public function header()
    {
        ...
        $this->cell(85, 10, $this->encodeString($this->title), 0, 0, 'C');
        // Se ubica la fecha y hora del servidor.
        //$this->cell(20, 0, '',  }  
        $this->setFont('Arial', '', 10);
        $this->cell(45, 5, 'Reporte generado el ', 0, 1, 'C');
        $this->cell(130, 10, '', 0);
        $this->cell(50, 5, date('d-m-Y').' a las '.date('H:i:s'), 0, 1, 'C');
        $this->cell(135, 5, '', 0, 0, 'C');
        $this->cell(40, 5, 'Generado por: '.$_SESSION['usuario'], 0, 1, 'C');
